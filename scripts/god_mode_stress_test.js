...
async function main() {
    console.log("--- Starting GOD-MODE Stress Test (Hardhat Dynamic ESM Native) ---");
    
    // Dynamically import Hardhat to bypass Node 24 ESM Top-Level Await REQUIRE_ASYNC_MODULE crash
    const hre = await import("hardhat");
    const { ethers, network } = hre.default || hre;
    
    const provider = network.provider; // The Hardhat Network Provider
