 ...
 * Sends an email from the Goldbackbond coaching account.
 */
  ...
  "scheduledNextSession": null OR {
    ...
    "topic": "The focus of the next session"
        ...
        try {
            ...
            console.error("Failed to parse Mentor AI JSON response:", text);
            res.status(200).json({
                reply: "Coach Alex is gathering his thoughts. One moment.",
                scheduledNextSession: null
            });
        }
  ...
  "evaluation": {
    ...
    "newWeakArea": "A short string (e.g. '30-day grace period') if they failed a specific concept, otherwise null"
        ...
        try {
            ...
            console.error("Failed to parse Tier Test AI JSON response:", text);
            res.status(200).json({
                reply: "The examiner is reviewing the standards. Let's try that again.",
                evaluation: null
            });
        }
